#!/usr/bin/yarn dev
/**
 * Uses an aray to create a stock list
 * Get requests can be used to list all products
 * Get requests can be used to reserve the product
 */
...
/**
 * @param {number} itemId - ID of product
 * @param {number} stock - Number of items available
 */
